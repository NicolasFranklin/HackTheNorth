...
def evaluate(weight_file_path, data_dir, output_dir, prob_thresh=0.5, nms_thresh=0.1, lw=3, display=False):
  ...
  with tf.Session() as sess:
    ...
    for filename in filenames:
      ...
      sheet = client.open_by_url('https://docs.google.com/spreadsheets/d/1aiAqFBH1LUB6oRoNhlWbA5ztsveuFmVEvpIec17Ohew/').sheet1
      sheet.update_cell(counter, 3, refined_bboxes.size // 5)
      counter += 1
        ...
        #     idx = idx + 1
        #     counter = counter + 1
        #     writer.writerow([lat, lon, refined_bboxes.size // 5, 'type', rg.search([lat,lon])[0]['name'], 'capacity'])
        # else:
        #   with open('data.csv', 'wb') as csvfile:
        #     writer = csv.writer(csvfile, delimiter=',', quotechar='|', quoting=csv.QUOTE_MINIMAL)
        #     writer.writerow(['Latitude', 'Longitude', 'Count', 'Type', 'Name', 'Capacity'])
        #     lat = lats[idx]
        #     lon = lons[idx]
        #     idx = idx + 1
        #     counter = counter + 1
